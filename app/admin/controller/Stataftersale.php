...
class Stataftersale extends AdminControl
{
    ...
    public function refundlist(){
        ...
        $statheader[] = array('text'=>lang('apply_time'),'key'=>'refundreturn_add_time');
        $statheader[] = array('text'=>lang('stattrade_refund_total'),'key'=>'refund_amount');
        $statheader[] = array('text'=>lang('seller_state'),'key'=>'refundreturn_seller_state');
        $statheader[] = array('text'=>lang('admin_state'),'key'=>'refundreturn_admin_state');
        foreach ((array)$refundlist_tmp as $k=>$v){
            ...
            foreach ((array)$statheader as $h_k=>$h_v){
                ...
                if ($h_v['key'] == 'refundreturn_admin_state'){
                    $tmp[$h_v['key']] = $v['refundreturn_seller_state']==2 ? $v['refundreturn_admin_state_desc']:lang('none');
                }
