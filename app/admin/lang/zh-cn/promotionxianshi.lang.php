...
$lang['xianshi_price'] = '秒杀价格';
$lang['xianshi_price_explain'] = '购买单位为月(30天)，购买后卖家可以在所购买周期内发布秒杀活动';
$lang['xianshi_price_error'] = '不能为空，且必须为大于0的正整数';

$lang['setting_save_success'] = '设置保存成功';
$lang['setting_save_fail'] = '设置保存失败';

$lang['xianshi_quota_list_help1'] = '卖家的秒杀套餐列表';
$lang['xianshi_list_help1'] = '卖家发布的秒杀活动列表';
