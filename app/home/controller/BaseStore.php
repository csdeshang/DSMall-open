    ...
    public function initialize() {
        ...
        if (in_array(request()->controller(),array('Store','StoreSpecial'))) {
            ...
            if(!$store_info['is_platform_store']){
                ...
                //营业执照
                if($storejoinin_info){
                    $this->store_info['business_licence_number_electronic']=($storejoinin_info['business_licence_number_electronic'] && $storejoinin_info['store_type']==0)?get_store_joinin_imageurl($storejoinin_info['business_licence_number_electronic']):'';
                }  
            }
