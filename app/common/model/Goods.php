...
//        $condition = $this->_getRecursiveClass($condition);
    ...
    public function getGoodsInfoAndPromotionById($goods_id) {
        ...
        //会员等级折扣
        if (empty($goods_info['bargain_info']) && empty($goods_info['presell_info']) && empty($goods_info['groupbuy_info']) && empty($goods_info['pintuan_info']) && empty($goods_info['xianshi_info']) && empty($goods_info['wholesale_info'])) {
    ...
    public function getGoodsDetail($goods_id) {
        ...
        if(!empty($goods_info['presell_info'])){
            ...
            $goods_info['presell_end_time'] = $goods_info['presell_info']['presell_end_time'];
            $goods_info['presell_shipping_time'] = $goods_info['presell_info']['presell_shipping_time'];
            $goods_info['presell_type'] = $goods_info['presell_info']['presell_type'];
            $goods_info['presell_deposit_amount'] = $goods_info['presell_info']['presell_deposit_amount'];
        ...
        //虚拟、F码、预售不显示加入购物车
        if ($goods_info['is_virtual'] == 1 || $goods_info['is_goodsfcode'] == 1 || (isset($goods_info['promotion_type']) && $goods_info['promotion_type'] == 'presell')) {
