...
class Storegoodsclass extends BaseModel {
    ...
    public function getStoregoodsclassInfo($condition, $field = '*') {
        ...
        return Db::name('storegoodsclass')->where($condition)->field($field)->find();
    }
    ...
    public function editStoregoodsclass($data, $where, $store_id) {
        ...
        $result = Db::name('storegoodsclass')->where($where)->update($data);
        if ($result) {
            $this->_dStoregoodsclassCache($store_id);
        }
        return $result;
    }
    ...
    public function delStoregoodsclass($where, $store_id) {
        ...
        $result = Db::name('storegoodsclass')->where($where)->delete();
        if ($result) {
            $this->_dStoregoodsclassCache($store_id);
        }
        return $result;
